...
from stanafra.app.schemas.auth import AuthUserPublic
from stanafra.app.db.models import AuthUser
...
@mock.patch("stanafra.app.db.models.auth.pwd_context.hash",
...
@mock.patch("stanafra.app.db.models.auth.AuthUser.get_password_hash",
            return_value="dummy")
