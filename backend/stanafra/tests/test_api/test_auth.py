...
from stanafra.app.utils.security import create_access_token
...
@mock.patch("stanafra.app.api.auth.create_access_token",
...
@mock.patch("stanafra.app.api.auth.store_user",
