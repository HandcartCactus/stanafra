...
from stanafra.app.utils.security import (
...
@pytest.mark.asyncio
@mock.patch("stanafra.app.utils.security.jwt.decode",
...
@pytest.mark.asyncio
@mock.patch("stanafra.app.utils.security.AuthUser.get_user")
...
@mock.patch("stanafra.app.utils.security.datetime")
@mock.patch("stanafra.app.utils.security.settings")
