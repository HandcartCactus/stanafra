...
import click
import logging
from stanafra.app.utils.logging import ColorFormatter, request_msg_format
...
class TestColorFormatter:
    ...
    @mock.patch("stanafra.app.utils.logging.click.style",
    ...
    @mock.patch("stanafra.app.utils.logging.logging.Formatter")
